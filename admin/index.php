...
<form> 
    ...
    <a href="release-train" class="register"> Release New Train </a><br><br><br>
    <a href="view-trains" class="register">View Trains</a><br><br><br>
    <a href="view-status" class="register">View Train Status</a><br><br><br>
    <a href="view-users" class="register">View Registered Users</a><br><br><br>
    <a href="view-bookings" class="register">View All Bookings</a><br><br><br>
    <div class="line-box">
      <div class="line"></div>
    </div>
